...
TWILIO_ACCOUNT_SID = os.getenv("AC4ef64d47ff7f1f2548908a47a738bec4")
TWILIO_AUTH_TOKEN = os.getenv("0ff2281b01e0b99036a752da8a63517a")
TWILIO_FROM_NUMBER = os.getenv("+14155238886")
SOS_TO_NUMBER = os.getenv("+916200824071")
